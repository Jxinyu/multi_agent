...
def test_openapi_excludes_server_paths_and_marks_protected_routes() -> None:
    ...
    assert schema["paths"]["/api/enterprise/overview"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/evaluation"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/evaluation/report"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/runtime/agents/{agent_id}"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/runtime/connections/{connection_id}"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/knowledge/runtime"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/evaluation/runs/{run_id}"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/evaluation/runs/{run_id}/dataset"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/search-analytics"]["get"]["security"]
    assert schema["paths"]["/api/enterprise/feedback-analytics"]["get"]["security"]
    ...
    assert schema["paths"]["/api/platform/tenants/{tenant_id}"]["get"]["security"]
    assert schema["paths"]["/api/platform/runtime"]["get"]["security"]
    assert schema["paths"]["/api/platform/runtime/services/{service_name}"]["get"]["security"]
    assert schema["paths"]["/api/platform/runtime/worker"]["get"]["security"]
    assert schema["paths"]["/api/platform/models"]["get"]["security"]
    assert schema["paths"]["/api/platform/models/detail"]["get"]["security"]
    assert schema["paths"]["/api/platform/settings"]["get"]["security"]
